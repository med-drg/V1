    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                await self.one.join_chat("SOZTS1")
            ...
            try:
                await self.one.send_message(
                    config.LOG_GROUP_ID, "تم تنصيب سورس التنين"
                )
            except:
        ...
        if config.STRING2:
            ...
            try:
                ...
                await self.two.join_chat("SOZTS1")
        ...
        if config.STRING3:
            ...
            try:
                ...
                await self.three.join_chat("SOZTS1")
        ...
        if config.STRING4:
            ...
            try:
                ...
                await self.four.join_chat("SOZTS1")
        ...
        if config.STRING5:
            ...
            try:
                ...
                await self.five.join_chat("SOZTS1")
